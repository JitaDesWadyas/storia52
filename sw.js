...
const SHELL_CACHE = `${CACHE_PREFIX}shell-v18`;
const RUNTIME_CACHE = `${CACHE_PREFIX}runtime-v18`;
const CORE_FILES = [
  './', './index.html', './privacy.html', './copyright.html',
  './clean-app.css', './refine-flow.css', './home-product.css', './app-polish.css', './home-fixes.css',
  './tutorial-game.css', './interaction-polish.css', './invite-polish.css', './release-ready.css', './loading-skeleton.css', './ux-rework.css', './scroll-fix.css', './content-polish.css', './public-release-polish.css', './release-fixes-v17.css',
