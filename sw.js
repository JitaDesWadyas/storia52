...
const CORE_FILES = [
  ...
  './tutorial-game.css', './interaction-polish.css', './invite-polish.css', './release-ready.css', './loading-skeleton.css', './ux-rework.css', './scroll-fix.css', './content-polish.css', './public-release-polish.css', './release-fixes-v17.css', './release-fixes-v19.css', './release-final-v21.css', './release-fixes-v23.css', './release-fixes-v26.css',
  './app.js', './ui-core.js',
  ...
  './clean-stories-markup.js', './clean-stories-view.js', './clean-objectives.js', './clean-prep.js',
  './qr-local.js', './invite-codec.js', './archive-v20-invite-codec.js', './clean-invite-host.js', './clean-invite-data.js', './clean-exit.js',
  './interaction-polish.js', './scroll-safety.js', './clean-init.js', './pwa-refresh-v26.js', './icon.svg', './storia52-cards-logo.svg', './creator-jita.svg',
