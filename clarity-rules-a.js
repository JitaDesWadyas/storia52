...
(() => {
  const G = window.G52;
  if (!G) return;
  G.cardTypesMarkup = (options = {}) => `<section class="card-types-guide${options.compact ? ' compact' : ''}"><div class="card-types-head"><span>PRIMA DI GIOCARE</span><h3>Non confondere questi tre gruppi.</h3></div><div class="card-types-grid"><article><span>1</span><div><b>4 carte della storia</b><p>Definiscono protagonista, situazione, obiettivo e problema. Sono comuni e restano sul telefono.</p></div></article><article><span>2</span><div><b>5 carte in mano</b><p>Sono le carte fisiche che giochi durante i turni.</p></div></article><article><span>3</span><div><b>1 obiettivo segreto</b><p>È privato, resta sul telefono e indica il finale da raggiungere.</p></div></article></div></section>`;
