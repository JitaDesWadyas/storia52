...
(() => {
  ...
  S.cardMeaningMarkup = () => `<div class="card-meaning-board"><section class="meaning-block"><div class="meaning-heading"><span>CARTE NUMERICHE · DA 2 A 10</span><h4>Leggi soltanto il seme.</h4><p>Il numero non cambia il significato della carta.</p></div><div class="plain-suit-grid"><article><span class="red">♥</span><div><b>Relazione</b><p>Cambia un rapporto tra personaggi: fiducia, vicinanza, tensione o tradimento.</p><em>Un vecchio amico decide di aiutare il protagonista.</em></div></article><article><span class="red">♦</span><div><b>Scoperta</b><p>Fa emergere un’informazione, un indizio o una verità importante.</p><em>Il protagonista trova una prova nascosta.</em></div></article><article><span>♣</span><div><b>Azione</b><p>Un personaggio prova a fare qualcosa di concreto.</p><em>Il protagonista tenta di aprire la porta bloccata.</em></div></article><article><span>♠</span><div><b>Ostacolo</b><p>Compare un problema che rende tutto più difficile.</p><em>La strada viene chiusa prima della fuga.</em></div></article></div></section><section class="meaning-block special-meaning-block"><div class="meaning-heading"><span>J · Q · K · A</span><h4>Guarda il valore e il colore. Ignora il seme.</h4><p>Queste carte introducono un nuovo elemento o una svolta. Rosso significa favorevole, nero significa problematico.</p></div><div class="special-rank-grid"><article><small>NUOVO ELEMENTO</small><b>J</b><span>Oggetto</span></article><article><small>NUOVO ELEMENTO</small><b>Q</b><span>Personaggio</span></article><article><small>NUOVO ELEMENTO</small><b>K</b><span>Luogo</span></article><article><small>SVOLTA</small><b>A</b><span>Colpo di scena</span></article></div><div class="special-color-rule"><section><span class="red">ROSSA</span><div><b>Entra a favore</b><p>Il nuovo elemento aiuta, oppure il colpo di scena migliora la situazione.</p></div></section><section><span>NERA</span><div><b>Entra come problema</b><p>Il nuovo elemento ostacola, oppure il colpo di scena peggiora la situazione.</p></div></section></div><p class="special-example"><strong>Esempio:</strong> un J♥ aggiunge un oggetto favorevole. Non crea anche una relazione: il simbolo ♥ viene ignorato.</p></section></div>`;
  ...
  S.turnGuideMarkup = () => guideMarkup({
    ...
    steps: [
      ...
      { title: 'Gioca una carta', text: 'Scegli una sola carta e racconta la scena seguendo il significato scritto sulla carta o indicato nelle regole.' },
